...
NAS_PHOTO_SUBDIR="${PIFRAME_NAS_PHOTO_SUBDIR:-media/photos}"
...
MIN_FREE_BYTES="${PIFRAME_MIN_FREE_BYTES:-1073741824}"
NAS_HOST="${NAS_SOURCE#//}"
NAS_HOST="${NAS_HOST%%/*}"
